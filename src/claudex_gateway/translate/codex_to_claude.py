...
# Preserve the legacy direct import used by existing callers outside the
# translator while production lookups resolve the definition module.
...
class CodexToClaudeStreamTranslator:
    ...
    def _rewrite_overflow_message(self, code: Any, message: Any) -> str | None:
        ...
        if not context_overflow.is_context_overflow_error(code, text):
            return None
